...
const DevicesSidebar = ({ isOpen, onClose }) => {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      case 'recent':
        return <span className="status-badge recent">● Baru saja</span>;
      default:
                ...
                >
                  ...
                  <div style={{
                    ...
                    <div style={{ marginBottom: '4px' }}>
                      ⏰ Terakhir aktif: <strong>{formatDate(device.last_active)}</strong>
                    </div>
                    <div>
                      📅 Login: <strong>{formatDate(device.created_at)}</strong>
                    </div>
                  </div>
